...
class Config:
    def __init__(self):
        ...
        # Directories
        self._configs["data_dir"]   = "backend/ExtremeNet/data"
        self._configs["cache_dir"]  = "backend/ExtremeNet/cache"
        self._configs["config_dir"] = "backend/ExtremeNet/config"
        self._configs["result_dir"] = "backend/ExtremeNet/results"
